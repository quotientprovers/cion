...
void __fullstates() {
    LAND3(reader_x->next == reader_y, ! reader_x->del, reader_k == reader_y->key);
    LAND4(reader_x->next == reader_y, ! reader_x->del, reader_x->key < reader_k, reader_k < reader_y->key);

    LAND7(reader_x->next == y, ! reader_x->del, reader_x->key < k, k < y->key, 
